...
def open_file(a):
    # Verify if argument passed ends with '.json'
    if re.search('.json$', a.f) is None:
        file_name = a.f + ".json"
    else:
        file_name = a.f
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-q','-quiet',
        action='store_true',
        help='supress warning message when emptying list'
    )
